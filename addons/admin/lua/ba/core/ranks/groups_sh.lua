...
function PLAYER:IsVIP()
	return ((hook.Call('PlayerVIPCheck', GAMEMODE, self) == true) or self:GetRankTable():IsVIP() or self:HasUpgrade('vip') or self:HasUpgrade('VIP') or self:HasUpgrade('vip_package'))
end
