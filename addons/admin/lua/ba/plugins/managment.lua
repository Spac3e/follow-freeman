ba.AddTerm('AdminFrozePlayer', '# был Заморожен #.')
ba.AddTerm('AdminUnfrozePlayer', '# был Разморожен #.')
ba.AddTerm('AdminUnmutedPlayer', '# снял Большую затычку #.')
ba.AddTerm('AdminUnmutedYou', 'с # снята Затычку.')
ba.AddTerm('YouAreUnmuted', 'С вас сняли Затычку.')
ba.AddTerm('AdminMutedPlayer', '# получил Затычку # на #.')
ba.AddTerm('AdminMutedYou', '# получил Большую Затычку на #.')
ba.AddTerm('MuteMissingTime', 'Ошибка: укажите правильно время.')
ba.AddTerm('AdminUnmutedPlayerChat', '# снял Затычку Чата с #.')
ba.AddTerm('AdminUnmutedYouChat', '# снял Затычку Чата.')
ba.AddTerm('YouAreUnmutedChat', 'Вам доступен чат.')
