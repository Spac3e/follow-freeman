...
function SWEP:DrawHUD()
	...
	draw.SimpleText( "Надеваем наручники...", "HandcuffsText", w+1, h+31, Col.TextShadow, TEXT_ALIGN_CENTER )
	draw.SimpleText( "Надеваем наручники...", "HandcuffsText", w, h+30, Col.Text, TEXT_ALIGN_CENTER )
