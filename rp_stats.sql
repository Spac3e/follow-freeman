...
--
-- Структура таблицы `perma_customjobs`
--

DROP TABLE IF EXISTS `perma_customjobs`;
CREATE TABLE IF NOT EXISTS `perma_customjobs` (
  `SteamID` bigint(20) NOT NULL,
...
(76561198797549224, 'Money', 1696920028),
(76561198797549224, 'Time', 1696923630),
(76561198797549224, 'Armor', 1696867833),
(76561198797549224, 'Event', 1697463634),
(76561198797549224, 'Gun', 1696984836);
...
(76561198797549224, 'Tany Ruis', 15133, 50, '{}', NULL);
