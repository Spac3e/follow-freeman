local citizens = {
	...
	TEAM_CITIZEN2 = rp.addTeam('Гражданин', {
		color = Color(150, 170, 200),
		model = citizens,
		description = [[
	...
	TEAM_CITIZEN3 = rp.addTeam('Добропорядочный Гражданин', {
		color = Color(150, 170, 200),
		model = citizens,
		description = [[
	...
	TEAM_CITIZEN4 = rp.addTeam('Доверенный Гражданин', {
		color = Color(150, 170, 200),
		model = citizens,
		description = [[
	...
	TEAM_CITIZEN5 = rp.addTeam('Почетный гражданин', {
		color = Color(150, 170, 200),
		model = citizens,
		description = [[
