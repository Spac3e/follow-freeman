...
rp.AddTerm('LegKilled', "Святой Джек был убит! Но он обязательно вернется!")
...
rp.AddTerm('AntihumanSpeedBoost3', 'Ваша скорость увлеичена!')
...
rp.AddTerm('Secboost', 'OWC.SEC увеличивает отряду MPF здоровье и броню!')
rp.AddTerm('Ovlboost', 'OTA.OVL увеличивает дивизиону OTA здоровье и броню!')
