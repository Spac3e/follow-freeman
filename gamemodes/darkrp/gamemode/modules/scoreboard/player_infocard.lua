...
local nicknames = cvar.Register('NickNames')
nicknames:SetDefault('')

function PLAYER:SetNickName(name)
	nicknames:AddMetadata(self:SteamID(), name)
	nicknames:Save()
end

function PLAYER:GetNickName()
	return nicknames:GetMetadata(self:SteamID())
end
...
function PANEL:UpdatePlayerData()
	...
	self.btnOrg:SetText('Org: ' .. (self.Player:GetOrg() and self.Player:GetOrg() or 'None'))
