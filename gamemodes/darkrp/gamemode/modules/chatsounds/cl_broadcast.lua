...
cvar.Register'broadcast_sound_level':SetDefault(0.7):AddMetadata('State', 'RPMenu'):AddMetadata('Menu', 'Громкость сообщений Альянса'):AddMetadata('Type', 'number')
...
net.Receive('rp.DoVoice', function()
	...
	voice.soundPatch:ChangeVolume(cvar.GetValue'broadcast_sound_level')
