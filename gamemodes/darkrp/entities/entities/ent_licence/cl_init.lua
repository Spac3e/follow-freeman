...
function ENT:Draw()
	...
	draw.SimpleText('Лицензия', '3d2d', 0, -50, color_black, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	draw.SimpleText('на оружие', '3d2d', 0, 50, color_black, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	cam.End3D2D()
end