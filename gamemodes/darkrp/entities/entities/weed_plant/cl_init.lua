...
function ENT:Draw()
	...
	cam.Start3D2D(pos, Angle(0, LocalPlayer():EyeAngles().yaw - 90, 90), 0.045)
		draw.SimpleTextOutlined((self:GetModel() ~='models/alakran/marijuana/pot_empty.mdl' and 'Марихуана' or 'Горшок'), '3d2d', 0, -100, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, 1, color_black)
	cam.End3D2D()
end